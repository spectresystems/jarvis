...
* You [license](https://github.com/spectresystems/jarvis/blob/develop/LICENSE) the contribution under the terms applied to the rest of the Jarvis project.
* You agree to follow the [code of conduct](https://github.com/spectresystems/jarvis/blob/develop/CODEOFCONDUCT.md).
...
If you want to introduce a dependency to Jarvis, make sure you bring it
 ...
 * Through GitHub, you talk about a feature you would like to see (or a bug), and why it should be in Jarvis.
 * Once you get a nod from one of the [Jarvis Team](https://github.com/spectresystems?tab=members), you can start on the feature.
 * Alternatively, if a feature is on the issues list with the
   [Up For Grabs](https://github.com/spectresystems/jarvis/labels/up-for-grabs) label,
 ...
 * You create, or update, a fork of `spectresystems/jarvis` under your GitHub account.
 * From there you create a branch named specific to the feature (i.e. feature/GH-32).
 ...
 * Once you feel it is ready, submit the pull request to the `spectresystems/jarvis` repository against the `develop` branch
 ...
 * One of the Jarvis team members, or one of the maintainers, will evaluate it within a
 ...
 * `git fetch upstream` (upstream would be the mainstream repo or `spectresystems/jarvis` in this case)
 * `git checkout develop`
 * `git rebase upstream/develop`
 * `git checkout your-branch`
 * `git rebase develop`
 * Fix any merge conflicts
 * `git push origin your-branch` (origin would be your GitHub repo or `your-github-username/jarvis` in this case).
...
If you reformat code or hit core functionality without an approval from a person on the Jarvis Team,
...
with permission and was edited to follow Jarvis' conventions and processes.